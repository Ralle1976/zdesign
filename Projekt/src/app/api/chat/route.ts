...
export async function POST(request: NextRequest) {
  try {
    ...
    // Fed into ALL paths: remote-fusion, in-app pipeline, and legacy chat — so the
    ...
    //      request DIRECTLY to the external Fusion HTTP service — no in-app LLM.
...
7. Double-check your JSON is valid before returning`;
    ...
    // Only for fresh generation — refinement preserves the existing aesthetic.
