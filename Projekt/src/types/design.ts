...
export interface DesignNodeMeta {
  ...
  role?: string;
  ariaLabel?: string;
  /** For type:'image' nodes awaiting generative imagery: the text-to-image prompt. */
  imagePrompt?: string;
  /** Lifecycle of generative imagery on an image node. 'pending' = client should generate. */
