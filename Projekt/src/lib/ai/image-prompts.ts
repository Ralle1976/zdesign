// Z.Design — MiniMax image prompt builders
//
// Domain-adaptive prompt construction for image-01: concrete, art-directed
// photography prompts per product family. Kept separate from the API client
// (image-minimax.ts) — one file builds prompts, the other talks to the API.
