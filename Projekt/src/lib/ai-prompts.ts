...
3. For nodes of type "image", do NOT output a URL: set "content" to empty, and set meta.imagePrompt (vivid generation prompt), meta.alt, and meta.imageStatus: "pending". Real images are generated asynchronously — no placeholder URLs.
