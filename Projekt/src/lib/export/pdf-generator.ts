...
<head>
  ...
  <title>${escapeHtml(projectName)} - Z.Design Export</title>
...
export async function generatePDF(
  ...
  try {
    ...
    browser = await puppeteer.launch({
      // @ts-expect-error pre-existing: headless 'new' literal not in current puppeteer types
      headless: 'new',
      args: [
        '--no-sandbox',
    ...
    // @ts-expect-error pre-existing: puppeteer imported as value, used as namespace type
