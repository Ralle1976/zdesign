# Graph Report - Z.Design  (2026-07-16)

## Corpus Check
- 327 files · ~1,715,629 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2439 nodes · 5262 edges · 185 communities (105 shown, 80 thin omitted)
...
## Communities (185 total, 80 thin omitted)
...
Cohesion: 0.10
Nodes (43): acceptHtmlDoc(), autoCloseHtml(), isValidHtmlDoc(), lintToRefinements(), POST(), TraceStep, acceptHtmlDoc(), autoCloseHtml() (+35 more)
...
### Community 7 - "cn"
Cohesion: 0.07
Nodes (42): AvatarImage(), BreadcrumbEllipsis(), BreadcrumbItem(), BreadcrumbLink(), BreadcrumbList(), BreadcrumbPage(), BreadcrumbSeparator(), Card() (+34 more)

### Community 8 - "DesignRenderer.tsx"
Cohesion: 0.07
Nodes (32): AnnotationPin, AnnotationPinProps, CanvasToolbar, DesignRenderer, DesignRendererProps, NodeRenderer, NodeRendererProps, getDefaultStyle() (+24 more)

### Community 9 - "props-editors.tsx"
Cohesion: 0.08
Nodes (38): Accordion(), AccordionContent(), AccordionItem(), AccordionTrigger(), AccessibilityScanner(), AccessibilityScannerProps, CATEGORY_CONFIG, ScoreCircle() (+30 more)
...
Cohesion: 0.07
Nodes (39): CanvasToolbarProps, NewProjectDialogProps, MODE_ICONS, StatusBar(), StatusBarProps, VIEWPORT_ICONS, CapabilitiesManifest, BUILT_IN_PROVIDERS (+31 more)
...
Cohesion: 0.08
Nodes (28): autoCloseHtml(), BatchBody, BatchDesignResult, BatchProgress, batchStore, buildBriefPrompt(), DesignBrief, mapWithConcurrency() (+20 more)
...
Cohesion: 0.10
Nodes (22): Button(), Textarea(), ChatPanel(), collectPendingImages(), ConceptCard, ConceptPicker(), EXAMPLE_PROMPTS, generateImagesForDesign() (+14 more)
...
Cohesion: 0.14
Nodes (20): Dialog(), DialogContent(), DialogDescription(), DialogFooter(), DialogHeader(), DialogTitle(), DialogTrigger(), Input() (+12 more)
...
Cohesion: 0.15
Nodes (23): FusionPipeline, FusionResult, FusionStageInfo, PANEL_ROLES, safeJsonParse(), TEMP, withTimeout(), describeRouting() (+15 more)
...
Cohesion: 0.13
Nodes (26): ChatRequestBody, POST(), CRAFT, DEFAULTS, deriveDesignDirection(), DesignDirective, DirectionDef, DIRECTIONS (+18 more)
...
Cohesion: 0.11
Nodes (28): callTextLLM(), getTextConfig(), isProviderConfigured(), PromptInput, TextLLMCallOptions, clamp(), critiquePrompt(), critiqueRendered() (+20 more)

### Community 26 - "provider-config.ts"
Cohesion: 0.12
Nodes (27): ENV_PATH, GET(), POST(), upsertEnvEntry(), GET(), GET(), POST(), bustTextLLMConfigCache() (+19 more)

### Community 27 - "DesignSystemManager.tsx"
Cohesion: 0.09
Nodes (26): Select(), SelectContent(), SelectItem(), SelectTrigger(), SelectValue(), COLOR_CATEGORIES, DEFAULT_BORDER_RADIUS, DEFAULT_SHADOWS (+18 more)

### Community 28 - "art-direction.ts"
Cohesion: 0.14
Nodes (19): POST(), POST(), MultiPassInput, ArtBrief, atmosphereGuidance(), briefLabel(), buildArtBrief(), CRAFT_DUTIES (+11 more)
...
### Community 30 - "db.ts"
Cohesion: 0.09
Nodes (5): GET(), since24h(), BUILT_IN_TEMPLATES, globalForPrisma, LogLevel
...
Cohesion: 0.16
Nodes (17): ResizableHandle(), ResizablePanel(), ResizablePanelGroup(), Tabs(), TabsContent(), TabsList(), TabsTrigger(), PropsPanel() (+9 more)

### Community 34 - "multi-pass-pipeline.ts"
Cohesion: 0.15
Nodes (21): getExperiencePrompt(), ensureImageSlots(), imageMapToPromptBlock(), assembleDocument(), buildIAPrompt(), buildViewPrompt(), extractJsonBlob(), extractSection() (+13 more)

### Community 35 - "fresh-images.ts"
Cohesion: 0.23
Nodes (19): getActiveImageProvider(), countVisibleImages(), ensureDesignImages(), injectHeroOnly(), applyFreshImages(), FreshImageOpts, generateHeroImage(), DesignPalette (+11 more)
...
Cohesion: 0.16
Nodes (10): Avatar(), AvatarFallback(), Popover(), PopoverContent(), PopoverTrigger(), ScrollArea(), Slider(), AnnotationsPanel() (+2 more)
...
Cohesion: 0.18
Nodes (15): GeneratedImage, generateImageMinimax(), generateImagesMinimax(), isMinimaxImageConfigured(), MinimaxImageOpts, minimaxKey(), NOTE: do NOT shortcut on `imagery` — it's the imageryGuidance boilerplate, collectSlots() (+7 more)

### Community 51 - "style-dna.ts"
Cohesion: 0.17
Nodes (13): POST(), StyleSelectorProps, COLOR_PALETTES, ColorPalette, generateStyleDNA(), getColorPalette(), getTypographyPreset(), STYLE_PRESETS (+5 more)
...
Cohesion: 0.22
Nodes (13): POST(), DATA_DIR, ensureDataDir(), LESSONS_PATH, LessonSignal, maybeReflect(), Outcome, readSignals() (+5 more)
...
### Community 84 - "loadUserMemory"
Cohesion: 0.48
Nodes (5): GET(), POST(), loadUserMemory(), MEMORY_PATH, saveUserMemory()
...
## Knowledge Gaps
- **598 isolated node(s):** `build.sh script`, `NEXT_TELEMETRY_DISABLED`, `start.sh script`, `$schema`, `style` (+593 more)
