...
## Summary
- 2441 nodes · 5271 edges · 181 communities (100 shown, 81 thin omitted)
...
Cohesion: 0.06
Nodes (63): GET(), POST(), auditCorrelations(), compositeOf(), confidenceFor(), Correlation, correlationsForField(), findCorrelations() (+55 more)
...
Cohesion: 0.08
Nodes (56): acceptHtmlDoc(), autoCloseHtml(), isValidHtmlDoc(), lintToRefinements(), POST(), TraceStep, acceptHtmlDoc(), autoCloseHtml() (+48 more)
...
Cohesion: 0.12
Nodes (21): CreativeRequestBody, POST(), AgentCallError, CreativeOrchestra, DEFAULT_CONFIG, ALL_SKILL_PACKS, CREATIVE_DIRECTOR_SKILL, CRITIQUE_AGENT_SKILL (+13 more)
...
Cohesion: 0.13
Nodes (30): getColorPalette(), DesignDirective, FusionPipeline, FusionResult, FusionRunInput, FusionStageInfo, FusionUnavailableError, minimalFallbackDesign() (+22 more)

### Community 20 - "negative-memory.ts"
Cohesion: 0.12
Nodes (21): main(), GET(), deriveValence(), DesignHistoryRow, recordDesign(), RecordDesignInput, TrustTier, wrapUntrusted() (+13 more)

### Community 21 - "server.ts"
Cohesion: 0.09
Nodes (33): check(), main(), POST(), detectInjection(), INJECTION_PATTERNS, sanitizePayload(), SanitizeResult, TRUST (+25 more)

### Community 22 - "index.ts"
Cohesion: 0.14
Nodes (21): ChatRequestBody, POST(), CRAFT, DEFAULTS, deriveDesignDirection(), DirectionDef, DIRECTIONS, directiveLabel() (+13 more)
...
Cohesion: 0.07
Nodes (38): AssistantAction, AssistantActionType, AssistantContext, AssistantResponse, buildSystemPrompt(), CANVAS_MODE_VALUES, EXPORT_VALUES, extractJsonObject() (+30 more)
...
### Community 30 - "db.ts"
Cohesion: 0.10
Nodes (6): POST(), sseLine(), STAGE_LABELS, StreamRequestBody, BUILT_IN_TEMPLATES, globalForPrisma
...
Cohesion: 0.13
Nodes (23): getExperiencePrompt(), imageMapToPromptBlock(), assembleDocument(), buildIAPrompt(), buildViewPrompt(), DesignIA, extractJsonBlob(), extractSection() (+15 more)
...
Cohesion: 0.17
Nodes (15): ConsolidationCandidate, ConsolidationStatus, listConsolidation(), promoteConsolidation(), proposeConsolidation(), toCandidate(), appendLessonHistory(), normAnti() (+7 more)
...
Cohesion: 0.19
Nodes (11): POST(), COLOR_PALETTES, ColorPalette, generateStyleDNA(), getTypographyPreset(), STYLE_PRESETS, styleDNAToPrompt(), TYPOGRAPHY_PRESETS (+3 more)
...
Cohesion: 0.21
Nodes (11): GET(), DATA_DIR, ensureDataDir(), LESSONS_PATH, LessonSignal, loadLessons(), Outcome, readSignals() (+3 more)
